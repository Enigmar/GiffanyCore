...
public class Device_raspberry_wohnzimmer_2 implements IExecutedSkill {
    ...
    public void restart() {
        if (App.appInstance.skillApi.powerControl.restartUnix("device_raspberry_wohnzimmer_2")) {
            this.executeResult();
        }
    }
